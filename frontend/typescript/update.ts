    ...
    if (id) {
        ...
        fetch(`${backendAddress}livros/livro/${id}/`)
            ...
            .then((livro: any) => {
                ...
                const capaElement = document.getElementById('capa') as HTMLImageElement;
            ...
            .catch(erro => {
                ...
                const mensagemElement = document.getElementById('mensagem') as HTMLDivElement;
                if (mensagemElement) {
        ...
        const atualizaButton = document.getElementById('atualiza') as HTMLButtonElement;
        if (atualizaButton) {
            atualizaButton.addEventListener('click', (evento) => {
                evento.preventDefault();

                const form = document.getElementById('upLivroForm') as HTMLFormElement;
